<?php
    ...
    $rows = $controller->getObjectsNoAccessibility();
?>

<div class="wrap">

<h2>Díla bez uvedené přístupnosti v kategorii '<?php print ($controller->getCategory()->nazev) ?>'</h2>

<p>Počet děl bez vyplněné přístupnosti: <?php print ($controller->getCountObjectsNoAccessibility()); ?></p>
